...
namespace DynamoDB_intro
{
  public static partial class Ddb_Intro
  {
    ...
    public static int Main( )
    {
            ...
            #region Create a Connection Client
      ...
      if( !pause( ) || operationFailed )
        return ( 1 );
            ...
            #region Read and Display an Item
      ...
      if( !pause( ) || operationFailed )
        return ( 1 );
            ...
            #region Update using various methods
      ...
      UpdateItemRequest updateRequest = new UpdateItemRequest()
      {
        ...
        UpdateExpression = "SET info.rating = :r, info.plot = :p, info.actors = :a",
          ...
          //Setting ReturnValues to NONE specifies that no update information should be returned.
          //However, when Main then waits on UpdatingMovie_async, it sets the report parameter to true.
          //This causes UpdatingMovie_async to change ReturnValues to ALL_NEW, meaning that the updated item should be returned in its entirety.
          ReturnValues = "NONE"
      };
      ...
      if( !pause( ) || operationSucceeded )
        return ( 1 );
            ...
            #region Deleting an Item
            //  7.  Try conditionally deleting the movie that we added
            //In this step, you try to delete a movie record with a condition that is not met, and the deletion fails.
            //Then, when the condition is changed so that it is met, the deletion succeeds (see 7b).
      ...
      if( !pause( ) || operationFailed )
        return ( 1 );
            ...
            #region Query using different methods
